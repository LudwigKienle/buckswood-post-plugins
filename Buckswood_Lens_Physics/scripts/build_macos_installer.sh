...
APP_NAME="Buckswood Lens Physics v0.5"
...
PKG_PATH="$RELEASE_DIR/Buckswood_Lens_Physics_Installer.pkg"
DMG_PATH="$RELEASE_DIR/Buckswood_Lens_Physics_Installer.dmg"
...
cp "$ROOT_DIR/dctl/Buckswood_Lens_Physics_v01.dctl" "$PKGROOT/Library/Application Support/Blackmagic Design/DaVinci Resolve/LUT/Buckswood_Lens_Physics_v01.dctl"
...
if [[ -n "$DEVELOPER_ID_INSTALLER" ]]; then
    SIGNED_PKG_PATH="$RELEASE_DIR/Buckswood_Lens_Physics_Installer_Signed.pkg"
...
(
    cd "$RELEASE_DIR"
    shasum -a 256 \
        Buckswood_Lens_Physics_Installer.pkg \
        Buckswood_Lens_Physics_Installer.dmg \
        > Buckswood_Lens_Physics_Installer_SHA256SUMS.txt
)
