...
APP_NAME="Buckswood Optics Lab v1.3"
...
PKG_PATH="$RELEASE_DIR/Buckswood_Optics_Lab_v1.3_Installer.pkg"
DMG_PATH="$RELEASE_DIR/Buckswood_Optics_Lab_v1.3_Installer.dmg"
...
if [[ -n "$DEVELOPER_ID_INSTALLER" ]]; then
    productsign \
        ...
        "$PKG_PATH" \
        "$RELEASE_DIR/Buckswood_Optics_Lab_v1.3_Installer_Signed.pkg"
    mv \
        "$RELEASE_DIR/Buckswood_Optics_Lab_v1.3_Installer_Signed.pkg" \
        "$PKG_PATH"
fi
...
(
    cd "$RELEASE_DIR"
    shasum -a 256 \
        Buckswood_Optics_Lab_v1.3_Installer.pkg \
        Buckswood_Optics_Lab_v1.3_Installer.dmg \
        > Buckswood_Optics_Lab_v1.3_SHA256SUMS.txt
)
