...
int main(int argc, char** argv)
{
    ...
    require(std::strcmp(plugin->pluginIdentifier, "com.buckswood.film.emulation") == 0, "plugin identifier matches");
    ...
    dlclose(library);
    std::cout << "Buckswood Film Emulation descriptor tests passed\n";
    return 0;
}
